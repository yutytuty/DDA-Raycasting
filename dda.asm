...
proc cast_ray
    ...
    ; wall_height
    ; ((BLOCK_SIZE * 200) / ray_length) / cos(player_angle - ray_angle)
    mov bx, offset cast_ray_wall_height
    fild [word ptr offset BLOCK_SIZE]
    mov [word ptr offset cast_ray_fpu_io], 200
    fild [word ptr offset cast_ray_fpu_io]
    fmulp ; BLOCK_SIZE * 200

    fld [dword ptr offset cast_ray_final_ray_length]
    fdivp ; (BLOCK_SIZE * 200) / ray_length
    ...
    fdivp ; ((BLOCK_SIZE * 200) / ray_length) / cos(player_angle - ray_angle)
    ...
    mov ax, 200
    mov [word ptr offset cast_ray_fpu_io], ax
    fild [word ptr offset cast_ray_fpu_io]
    fcomp
    fnstsw ax
    sahf ; 200, wall_height
    ja cast_ray_wall_height_less_than_two_hundered
        fstp
        fild [word ptr offset cast_ray_fpu_io]
    cast_ray_wall_height_less_than_two_hundered:
